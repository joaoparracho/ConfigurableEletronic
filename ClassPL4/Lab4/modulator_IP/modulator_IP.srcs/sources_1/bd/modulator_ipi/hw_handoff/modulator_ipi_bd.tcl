...
proc create_root_design { parentCell } {
  ...
  set counter_0 [ create_bd_cell -type ip -vlnv MEE_EC:user:counter:1.0 counter_0 ]
  set_property -dict [ list \
   CONFIG.cnt_value_p {"0011111111"} \
   CONFIG.depth_p {"0000001000"} \
 ] $counter_0

  # Create instance: frequency_trigger_0, and set properties
  set frequency_trigger_0 [ create_bd_cell -type ip -vlnv MEE_EC:user:frequency_trigger:1.0 frequency_trigger_0 ]

  # Create instance: pwm_0, and set properties
  set pwm_0 [ create_bd_cell -type ip -vlnv MEE_EC:user:pwm:1.0 pwm_0 ]

  # Create instance: sine_0, and set properties
  set sine_0 [ create_bd_cell -type ip -vlnv MEE_EC:user:sine:1.0 sine_0 ]
  set_property -dict [ list \
   CONFIG.depth_p {"0000001000"} \
   CONFIG.width_p {"0000001100"} \
 ] $sine_0
